...
//        }
        ...
        System.out.println(String.format(localLocale, "%s$%d", arrayOfObject));


        System.out.println( getUserAccessToken(arrayOfObject, localLocale));

//        100
//        11111$100
//                FC62118AC23BC73DB5E2B1E64CC8BC85

    }

    public static String  getUserAccessToken(Object[] arrayOfObject,Locale localLocale) {
        try {
            return EncryptUtils.encrypt("AES", String.format(localLocale, "%s$%d", arrayOfObject), "1QAZXSW23EDCVFR4");
        }catch (Exception e){
            return null;
        }
    }
